...
// darkMode button
// const darkMode = document.getElementById("buttonMode");
// let count = 0;
// function changeMode() {
//   if (count == 0) {
//     console.log("dark");
...
//     document.documentElement.style.setProperty("--color-paragraphe", "#fff");
//     count++;
...
//     document.documentElement.style.setProperty("--color-paragraphe", "#666");
//     count--;
//   }
// }
...
//Buttons section
document.querySelector(".buttonsNav").addEventListener("click", function (e) {
  e.preventDefault();
